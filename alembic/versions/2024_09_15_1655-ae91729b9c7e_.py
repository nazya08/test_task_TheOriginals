...
Revision ID: ae91729b9c7e
Revises: 
Create Date: 2024-09-15 16:55:10.956725
...
def upgrade() -> None:
    ...
    op.create_index(op.f('ix_cardcomment_id'), 'cardcomment', ['id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_cardcomment_id'), table_name='cardcomment')
